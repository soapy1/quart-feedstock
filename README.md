...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/quart-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/quart-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `quart` can be installed with `conda`:
...
It is possible to list all of the versions of `quart` available on your platform with `conda`:
...
```
mamba search quart --channel conda-forge
```
...
mamba repoquery search quart --channel conda-forge

# List packages depending on `quart`:
mamba repoquery whoneeds quart --channel conda-forge

# List dependencies of `quart`:
mamba repoquery depends quart --channel conda-forge
```
